	...
	var Organ = React.createClass({
	  ...
	  render: function () {
	    ...
	    var keys = keyNames.map(function (keyName, idx) {
	      ...
	      return React.createElement(Key, { key: idx, className: className, noteName: keyName });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Key = React.createClass({
	  ...
	  render: function () {
	    ...
	    } else if (this.state.pressed && this.props.className.includes("black")) {
	      className = this.props.className + " black-active";
	    } else {
